...
public class LinkedAdd {
        public Elem.Node add(Elem e1, Elem e2){
            Elem.Node pre=e1.getNode();
            Elem.Node qre=e2.getNode();
            Elem.Node p=pre.next;
            Elem.Node q=qre.next;
            Elem.Node result=p;
            while(p!=null && q!=null){
                if(p.exp<q.exp){
                    pre=p;
        ...
        public static void main(String[] args) {
            ...
            Elem.Node node=l.add(node1, node2);
            while(node!=null){
