...
//        System.out.println(bank0.getCustomer(1).getFirstName());
//        System.out.println(bank0.getCustomer(2).getFirstName());
//        System.out.println(bank0.getCustomer(3).getFirstName());
//        System.out.println(bank0.getCustomer(4).getFirstName());
    }
}
